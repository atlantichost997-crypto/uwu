            ...
            {!user ? (
              <div className="flex items-center gap-3">
                <button 
                  ...
                  className="glass border border-white/10 text-white text-xs font-bold px-4 py-2.5 rounded-xl hover:bg-white/10 transition-all flex items-center gap-2"
                >
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                    <motion.button 
                      ...
                      onClick={handleGoogleLogin}
                      disabled={authLoading}
                      className="w-full sm:w-auto bg-white text-black font-bold px-10 py-5 rounded-2xl hover:bg-zinc-200 transition-all flex items-center justify-center gap-4 shadow-[0_0_40px_rgba(255,255,255,0.1)] disabled:opacity-50 text-lg"
                    >
                      {authLoading ? (
                    ...
                    <motion.button 
                      ...
                      onClick={handleDiscordLogin}
                      disabled={authLoading}
                      className="w-full sm:w-auto bg-discord text-white font-bold px-10 py-5 rounded-2xl hover:bg-discord-hover transition-all flex items-center justify-center gap-4 shadow-[0_0_40px_rgba(88,101,242,0.4)] disabled:opacity-50 text-lg"
                    >
                      {authLoading ? (
                        <Loader2 className="w-6 h-6 animate-spin" />
                      ) : (
                ...
                <div className="flex items-center gap-4">
                  <div className="relative group">
                    ...
                    <input 
                      ...
                      className="glass bg-black/20 border border-white/10 rounded-2xl pl-11 pr-6 py-2.5 text-sm focus:outline-none focus:border-indigo-500/50 transition-all w-full sm:w-64"
                    />
                  </div>
                  <div className="glass px-5 py-2 rounded-full border border-white/10 flex items-center gap-2 shrink-0">
                ...
                {subdomains.filter(sub => 
                  ...
                  >
                    ...
                    <p className="text-zinc-500 font-medium text-lg">
                      {searchQuery ? `No results found for "${searchQuery}"` : "No active subdomains found."}
                    </p>
                    <p className="text-zinc-600 text-sm mt-2 font-light">
                      {searchQuery ? "Try a different search term." : "Create your first record to see it here."}
                    </p>
                  </motion.div>
                ) : (
                  subdomains
